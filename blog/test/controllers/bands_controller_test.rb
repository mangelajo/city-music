...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { description: @band.description, name: @band.name, rating: @band.rating, website: @band.website } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { description: @band.description, name: @band.name, rating: @band.rating, website: @band.website } }
